...
var sValorCal="";
			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #a7ff83; background-color: #a7ff83";/*celdas correctas: verde*/
					}
					else
						sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #fa4659; background-color: #fa4659";/*celdas incorrectas: rojo*/
				}
			}
	...
	if (sErr == "")
		document.getElementById("calificacion").innerHTML="La calificación es: "+nCalif;/*numero de aciertos*/
	else
		alert(sErr);
}